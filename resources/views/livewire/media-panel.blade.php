            ...
            @if($media)
                ...
                <div class="pb-4 pt-4 relative">
                    <div class="flex gap-x-4 text-sm">
                        <a href="{{ getMediaFullPath($media) }}" download class="group border rounded p-1.5 inline-flex items-center font-medium text-blue-500 group-hover:text-blue-900 dark:text-blue-300 dark:group-hover:text-blue-400">
